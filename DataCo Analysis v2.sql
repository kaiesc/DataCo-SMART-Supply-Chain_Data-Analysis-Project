...
SELECT 
	...
	ROUND(100.0 * (SUM("Order Profit Per Order")::numeric/SUM("Sales")::numeric), 2) AS "Profit Margin Percentage"
FROM supplychainds
...
SELECT 
	...
	ROUND(SUM("Sales")::numeric, 2) AS "Total Spend",
...
SELECT 
		...
		"Delivery Status"
FROM supplychainds
WHERE "Order Region" = 'Central America' AND "Shipping Mode" = 'First Class' AND "Delivery Status" = 'Late delivery'
